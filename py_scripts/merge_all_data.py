...
def merge_all_data(software_path):
    ...
    housing_scenario.merge(jtmt_scenario, how="outer").fillna(0).merge(trend_scenario, how="outer").fillna(0).to_excel(r'{}\find_year_for_new_neighborhood_by_scenario.xlsx'.format(software_path), index=False)