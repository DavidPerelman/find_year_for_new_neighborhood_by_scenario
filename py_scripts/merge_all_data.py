...
def merge_all_data():
    ...
    housing_scenario.merge(jtmt_scenario, how="outer").merge(trend_scenario, how="outer").to_excel(r'C:\Users\dpere\Documents\JTMT\find_year_for_new_neighborhood_by_scenario\find_year_for_new_neighborhood_by_scenario.xlsx', index=False)